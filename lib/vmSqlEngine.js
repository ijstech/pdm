...
(function (SQLEngine) {
        ...
        loadFromBlob(fileName, blob, publicAccess){            
            ...
            return new Promise(async function(resolve, reject){
                try{                    
                    ...
                    delete file.deleted;
                    let result = await $$pdm.writeFile(file, blob);                     
                    self._setFile(file);   
                    resolve()
                }
                catch(err){                                            
    ...
    class _TPDContext {
        ...
        async _updateAcl(callback) {
            ...
            return new Promise(async function (resolve, reject) {
                try {
                    $$pdm.fetch(self._endPoint, qry, function (err, result) {                        
                        if (err)
                            return reject(err);
                        self._loadAcl = false;                        
        ...
        execSQL(sql, params) {
            ...
            return new Promise(async function (resolve, reject) {
                try {
                    $$pdm.fetch(self._endPoint, qry, function (err, result, fields) {                        
                        if (err)
                            reject(err);
                        else
                            resolve(result);
        ...
        query(query) {
            ...
            return new Promise(async function (resolve, reject) {
                try {
                    $$pdm.fetch(self._endPoint, qry, function (err, data) {                        
    ...
    class _TPDRecordSet {
        ...
        getChangeLog(record, callback) {
            if (this._SQL._keyFields.length == 1) {
                ...
                return new Promise(async function (resolve, reject) {
                    try {
                        $$pdm.fetch(self._context._endPoint, qry, function (err, data) {
